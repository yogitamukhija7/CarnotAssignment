...
def replaceRepetition(tweet):
	...
	"""return list of words in tweet after replacement and numner of repetion
...
def removeTarget(tweet, token):
	"""returns list of words in tweet after replacement 
	@**** -> @ """
    	newToken = []
    	newTweet = []
    	for i in range(len(tweet)):
...
def removeUrl(tweet, token):
	"""retursn list of words in tweet after replacement 
    	www.*.* ->'URL' """
    	newToken = []
    	newTweet = []
    	for i in range(len(tweet)):
...
def removeNumbers(tweet, token):
	""" return list of words in tweet after removing 
    	numbers """
    	newToken = []
    	newTweet = []
    	for i in range(len(tweet)):
...
def removeProperCommonNoun(tweet, token):
	""" returns list of words in tweet after removing 
	numbers """
    	newToken = []
    	newTweet = []
    	for i in range(len(tweet)):
